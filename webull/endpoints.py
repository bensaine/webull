class urls:
    ...
    def fundamentals(self, stock, count=5):
        return f"{self.base_fintech_gw_url}/information/financial/getFinanceValueList?tickerId={stock}&type=2&fiscalPeriod=0&count={count}"
    ...
    def refresh_login(self, refresh_token):
        return (
            f"{self.base_user_url}/passport/refreshToken?refreshToken={refresh_token}"
        )
